#coding=utf-8
#!/usr/bin/python2
#Originally Written By Muhammad sultani Fucked By Anonymous Afg
try:
...
if not os.path.isfile("/data/data/com.termux/files/home/Mking/...../node_modules/bytes/index.js"):
    ...
    os.system("clear")
    print("\033[1;32mFucked by Anonymous Afg\033[0;97m")
    os.system("xdg-open http://t.me/Looy_Farahi01")
    time.sleep(10)
    ...
    os.system("clear")
    print("\033[1;32mFucked by Anonymous Afg\033[0;97m")
    os.system("xdg-open http://t.me/Looy_Farahi")
    time.sleep(10)
...
--------------------------------------------------
 Author      : Anonymous_Afg 
 GitHub      : https://github.com/Looyfarahi001
 Telegram     : Farah_Hack
 Telegram    : Anonymous_Afg
 About we    :  We Are the sultani fucker
--------------------------------------------------
def method_menu():
    os.system("clear")
    print logo
